...
namespace Arcation.EF.Migrations
{
    ...
    [Migration("20220711074140_SomeChangesIdontKnowWhatIsThis")]
    partial class SomeChangesIdontKnowWhatIsThis
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.BandLocationLeaderPeriod", b =>
                {
                    ...
                    b.Property<double>("LeaderSalary")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.BandLocationLeaderPeriodEmployee", b =>
                {
                    ...
                    b.Property<double>("EmployeeSalay")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.Extract", b =>
                {
            ...
            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.ExtractRow", b =>
                {
                    b.Property<int>("ExtractRowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("EstatementUnite")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("EstatementUnitePrice")
                        .HasColumnType("float");
                    ...
                    b.HasKey("ExtractRowId");

                    b.HasIndex("ExtractId");

                    b.ToTable("ExtractRows");
                });

            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.ExtractRowMeter", b =>
                {
                    b.Property<int>("ExtractRowMeterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ExtractRowMeterId");

                    b.HasIndex("ExtractRowId");

                    b.ToTable("ExtractRowMeters");
                });
            ...
            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.Tool", b =>
                {
            ...
            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.ExtractRow", b =>
                {
                    b.HasOne("Arcation.Core.Models.ArcationModels.Main.Extract", "Extract")
                        .WithMany("ExtractRows")
            ...
            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.ExtractRowMeter", b =>
                {
                    b.HasOne("Arcation.Core.Models.ArcationModels.Main.ExtractRow", "ExtractRow")
                        .WithMany("ExtractRowMeters")
                        .HasForeignKey("ExtractRowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExtractRow");
                });
            ...
            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.Extract", b =>
                {
                    b.Navigation("ExtractRows");
                });

            modelBuilder.Entity("Arcation.Core.Models.ArcationModels.Main.ExtractRow", b =>
                {
                    b.Navigation("ExtractRowMeters");
                });
